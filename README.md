...
| [awesome-vibe-skills](https://github.com/gtskevin/awesome-vibe-skills) | `bash <(curl -s https://raw.githubusercontent.com/gtskevin/awesome-vibe-skills/main/scripts/install.sh) --all` | Curated collection of 10 high-quality, ready-to-install AI coding agent skills. Covers code review, security scanning, test generation, docs, performance, refactoring, commit messages, API review, i18n, and changelog. Bilingual (中文/English) with one-click installer.
| [vibe-check](https://github.com/gtskevin/vibe-check) | `curl -sSL https://raw.githubusercontent.com/gtskevin/vibe-check/main/SKILL.md -o ~/.claude/skills/vibe-check/SKILL.md` | Quality gate for AI-generated code. Single SKILL.md that checks security, correctness, structure, performance, testing, and docs. Say "vibe check" to get a scorecard.
| [vibe-toolkit](https://github.com/gtskevin/vibe-toolkit) | `curl -sSL https://raw.githubusercontent.com/gtskevin/vibe-toolkit/main/vibe -o /usr/local/bin/vibe && chmod +x /usr/local/bin/vibe` | The missing CLI for AI coding assistants. Install skills, validate SKILL.md files, scaffold new skills. One Python file, zero dependencies.
