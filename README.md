...
| [claude-code-hooks](https://github.com/minhluongg/claude-code-hooks) | new | 26 hooks across security, git, testing, quality, formatting and context. Every hook is executed as a real child process against a real Claude Code payload in CI — 103 assertions, green on Windows, macOS and Linux. Plain Node, zero dependencies: no bash, jq, or Python. Hooks fail open — an unexpected error exits 0 rather than ending the session. MIT |
