...
| [diffmode-growth-tactics](https://github.com/acogood/diffmode_free) | Free growth-strategy pipeline for bootstrapped founders. Point it at a product URL and it researches your market and writes a competitor read, a buyer jobs-to-be-done map, and 7–9 unconventional acquisition tactics (synthesis.md) — each fusing 2–3 growth mechanisms from fresh case studies. Reviewer-gated stages. Runs on Claude Code and Codex; Apache-2.0, no account/API key, Perplexity-optional. |
