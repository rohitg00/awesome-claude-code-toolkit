...
| [suede-creator-skills](https://github.com/JasonColapietro/suede-creator-skills) | `npx skills add JasonColapietro/suede-creator-skills@suede-workflow-skills` | MIT-licensed 21-skill workflow pack for Codex and Claude Code: portable agent context, Suedify site restyling, Johnny Suede write/design modes, SEO/AEO/AI EO, visibility and code grading, AI evals, agent teams, ship gates, launch packaging, and MCP QA. |
