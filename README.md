...
| [roadmapsmith](https://github.com/PapiScholz/roadmapsmith) | `npx skills add https://github.com/PapiScholz/roadmapsmith` | Keep ROADMAP.md in sync with the codebase — `/roadmap-init` scans a repo to generate a roadmap, `/roadmap-update` proposes marking tasks complete when supporting evidence is detected in the code. Works with Claude Code, Codex, and any SKILL.md host. MIT. |
