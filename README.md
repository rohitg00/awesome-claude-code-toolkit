...
| [CoderPlan](https://coderplan.ai) | -- | Unified LLM API gateway for Claude Code, Codex CLI, and Gemini CLI. OpenAI-compatible endpoint supporting Claude, GPT, Gemini, DeepSeek with pay-per-use billing. China-optimized with Alipay/WeChat payments and domestic direct connection |
