...
| [claude-auto-retry](https://github.com/cheapestinference/claude-auto-retry) | 222+ | Auto-resumes Claude Code when it hits usage limits or API overload (529/5xx) — parses the printed reset time, waits, and continues the session in tmux. Exponential backoff, zero dependencies |
