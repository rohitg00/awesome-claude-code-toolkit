...
| [zclean](https://github.com/TheStack-ai/zclean) | 57+ | AI coding runtime hygiene for Claude Code, Codex, Cursor, Windsurf, MCP servers, and local dev caches. Dry-run first, zero dependencies, published as `@thestackai/zclean` |
