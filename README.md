...
| [sessionmem](https://github.com/catfish-1234/sessionmem) | Local-first MCP server that watches coding sessions and injects a compact summary at the start of each new session. 85.6% token reduction, SQLite storage, no cloud. Works with Claude Code, Cursor, Cline, Windsurf |
