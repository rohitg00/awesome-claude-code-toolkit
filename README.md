...
| [Vetto](https://github.com/shleder/vetto) | new | Daemon-less, 0ms sandbox for Claude Code, Codex, and Cursor — Linux Landlock LSM (ABI v1-v6) + macOS Seatbelt, transparent PATH shimming, zero-config network allowlists, git rollback guard, and MCP server isolation without Docker |
