...
| [hello-boss](https://github.com/babyGao/agent-pilot-skills/tree/main/skills/hello-boss) | `npx skills add babyGao/agent-pilot-skills -s hello-boss -g -y` | Outbound sales pipeline: five enumeration paths to map every industry that could buy what you do, four-signal entity resolution from public business registries, and a four-part cold email. Produces three named deliverables |
