...
| [Hephaestus](https://github.com/agentlas-ai/Hephaestus) | 56+ | Open Agent OS for Claude Code, Codex, and Cursor with meta-agent building, A2A Hub routing, local ontology, and memory/security gates. |
