...
| [SandBase Agent Skills](https://github.com/sandbaseai/sandbase-skills) | `/plugin marketplace add sandbaseai/sandbase-skills` then `/plugin install sandbase-skills@sandbase-agent-skills` | 88 Apache-2.0 Agent Skills for evidence-led research, social intelligence, marketing, and business workflows. Includes an offline validator for source attribution, contradictions, and confidence claims. |
