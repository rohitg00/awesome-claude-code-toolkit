...
| [agent-runbook](https://github.com/KnoxOps/agent-runbook) | new | Python CLI that compiles contract-based YAML runbooks into SKILL.md files for Claude Code and Codex agents. Define multi-step workflows with loops, branching, parallelism, and checkpoint-based resume — file-based state passing keeps context clean between steps. `pip install git+https://github.com/KnoxOps/agent-runbook.git` |
