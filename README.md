...
| [faf-skills](https://github.com/Wolfe-Jam/faf-skills) | 7 Claude Code skills for the FAF workflow: author & score `.faf` project context (IANA-registered `application/vnd.faf+yaml`), maintain the repo, and generate + run championship-grade test suites. Anthropic MCP #2759. |
...
| [faf-skills](https://github.com/Wolfe-Jam/faf-skills) | `git clone` | 7 Claude Code skills for the FAF workflow: author & score `.faf` project context (IANA-registered `application/vnd.faf+yaml`), maintain the repo, and generate + run championship-grade test suites. Anthropic MCP #2759. |
