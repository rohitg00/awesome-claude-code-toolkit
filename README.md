...
| [x-skills](https://github.com/sergebulaev/x-skills) | `/plugin marketplace add sergebulaev/x-skills` | 6 X (Twitter) marketing skills: tweets and auto-threads, hook extractor, humanizer, reply drafter, weekly planner |
