...
| [great_cto](https://github.com/avelikiy/great_cto) | Multi-agent SDLC plugin for Claude Code. 34 specialist reviewer agents (security, qa, code-reviewer, pci, fda-samd, voice-AI, etc.) across 25 archetypes. 10 compliance packs auto-attach by archetype (PCI, HIPAA, FDA SaMD, NYC AEDT, GDPR, voice, clinical, drug-discovery, lending, robotics). Two human gates per feature + memory feedback loop. MIT, runs locally |
