...
| [Ivy Tendril](https://github.com/Ivy-Interactive/Ivy-Tendril) | 200+ | Open-source AI coding orchestrator that manages Claude Code (and Codex, Antigravity, Copilot, OpenCode) through a plan-based lifecycle with verification gates, self-improving memory, and git worktree isolation. [Website](https://tendril.ivy.app). FSL |
