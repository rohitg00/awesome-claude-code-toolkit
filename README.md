...
| [mindpowers](https://github.com/rohitgehe05/mindpowers) | Problem-first knowledge-work plugin: validates problem claims against evidence, shapes rough ideas into locked specs, drafts and reviews documents, and remembers preferences. Five skills, nine document templates, and support for Claude Code, Cowork, Codex, ChatGPT desktop, and Cursor. Install: `/plugin marketplace add rohitgehe05/mindpowers` then `/plugin install mindpowers@mindpowers`. MIT |
