...
| [backbrief-kit](https://github.com/charlesashe/backbrief-kit) | Drops a coordinated agent team into any Claude Code project: an orchestrator that plans and routes, specialist agents, and a fresh-context verifier that reads finished work cold. Free, plain Markdown, one-instruction install. |
