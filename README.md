...
| [usage](https://github.com/aqua5230/usage) | 133 | macOS menu bar tracker for Claude Code and Codex quota (5h / 7d), tokens, and cost. Reads statusLine hook output and Codex session JSONL locally — zero API calls. HTML reports, 9 visual themes, Homebrew install, 5-language i18n. AGPL-3.0 |
