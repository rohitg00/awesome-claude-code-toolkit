...
| [ax](https://github.com/Necmttn/ax) | 31+ | Local-first telemetry and memory graph for Claude Code, Codex, Pi, OpenCode, and Cursor sessions. CLI, dashboard, and MCP views for recall, costs, skills/hooks, dispatches, and workflow extraction |
