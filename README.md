...
| [usage](https://github.com/aqua5230/usage) | 280 | macOS menu bar and Windows tray tracker for Claude Code, Codex, and Antigravity quota (5h / 7d), tokens, and cost. Claude Code and Codex read statusLine hook output and session JSONL locally — no LLM API calls. HTML reports, 9 visual themes, Homebrew install, 5-language i18n. AGPL-3.0 |
