...
| [Forward Deployed Selling](https://github.com/vonarmen-wq/forward-deployed-selling) | `git clone https://github.com/vonarmen-wq/forward-deployed-selling ~/.claude/skills/forward-deployed-selling` | Enterprise AI sales methodology for the AI era — ICP targeting, multi-threaded deal mapping, exec-presence writing, and account research doctrine. Built inside AWS across $500K–$500M deals. Drop it in Claude and every output (outreach, account plans, exec briefs) comes back doctrine-shaped. Free and open source. |
