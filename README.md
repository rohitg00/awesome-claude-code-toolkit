...
| [Vetto](https://github.com/shleder/vetto) | new | Daemon-less, 0ms sandbox for Claude Code, Codex, and Cursor — Linux Landlock LSM (ABI v1-v6) + macOS Seatbelt, transparent PATH shimming, Linux network allowlists, session snapshot rollback, Git push protection, and MCP server isolation without Docker |
