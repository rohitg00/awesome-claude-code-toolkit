...
| [UIZZE](https://uizze.com) | `npx skills add https://uizze.com --skill anti-ui-slop` | Reference-first UI workflow for Claude Code, Codex, and Cursor: search 800,000+ real web and iOS screens, define a design contract, and run a finish-gate review. |
