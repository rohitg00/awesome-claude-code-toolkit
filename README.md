...
| [EDC](https://github.com/almogdepaz/EDC) | Local repo-context plugin and CLI for Claude Code. Generates `edc-context/` module docs, invariants, trust boundaries, review notes, and routing metadata, then uses that context during review/audit workflows. |
