...
| [Agent FM](https://github.com/agentfm-ai/agent-fm) | new | Local, open-source macOS companion for Claude Code and Codex sessions. Turns active agents into narrated stations with Global Mix, blocker alerts, and BYOK Gemini/OpenAI narration |
