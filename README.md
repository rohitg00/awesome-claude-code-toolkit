...
| [skillsync-team](https://github.com/OmarNassar1127/skillsync-team) ([npm](https://www.npmjs.com/package/skillsync-team)) | Git-native skill sharing for Claude Code teams. Push/pull skills via a shared Git repo, semantic search across the team's skills (offline ONNX, ~150ms cached), archive lifecycle (skills moved to `~/.skillsync/archive/`), interactive checkbox pickers, auto version bump on push, tab completion (bash/zsh/fish), and auto-sync via UserPromptSubmit hook. MIT. Install: `npm i -g skillsync-team` |
