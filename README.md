...
| [devhelm-mcp-server](https://github.com/devhelmhq/mcp-server) | -- | Uptime monitoring, incident management, alerting, and dependency status via MCP. Manage monitors, query third-party service health, and configure alert channels. PyPI: `devhelm-mcp-server`. [Docs](https://docs.devhelm.io) |
