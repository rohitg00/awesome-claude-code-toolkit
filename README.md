...
| [overloop-cli](https://github.com/sortlist/overloop-cli) | new | AI-powered outbound engine CLI -- source 450M+ contacts, launch email + LinkedIn campaigns, manage conversations. JSON output, agent-native. `npm i -g overloop-cli` |
| [signals-cli](https://github.com/sortlist/signals-cli) | new | Intent signal monitoring CLI -- LinkedIn company engagers, keyword posters, job changers, funding events. JSON output for agent pipelines. `npm i -g signals-sortlist-cli` |
