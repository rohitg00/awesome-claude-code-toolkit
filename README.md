...
| [conversion-craft](https://github.com/nemolabsdev/conversion-craft) | Complete conversion-design team: 9 agents (adversarial art-director on Opus), 16 research-sourced skills, 3 mechanical QA gates incl. a rendered-page geometry audit (per-line CPL, fold contracts, computed-style asserts). Self-audited across 8 public rounds. MIT. Install: `/plugin marketplace add nemolabsdev/conversion-craft` |
