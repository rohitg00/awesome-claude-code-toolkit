...
| [incident](https://github.com/mturac/incident) | Production incident response in Claude Code. Triage errors from Sentry, Datadog, or raw logs. Hypothesis-driven diagnosis, root cause analysis, fix generation, and blameless postmortems with 5-Why RCA. Optional MCP server for direct Sentry/Datadog API access. |
