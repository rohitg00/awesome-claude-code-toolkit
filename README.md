...
| [url-manager](https://github.com/Piccolo123/url-manager) | - | Agent-first cross-platform URL collection & knowledge management. AI agents auto-register, collect, categorize, tag, search, and share web links. 20 MCP tools, collaborative shared categories, full-text search, magic-link delivery. Install: `openclaw skills install @piccolo123/url-manager` |
