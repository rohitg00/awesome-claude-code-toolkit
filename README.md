...
| [Loupe](https://github.com/winchxyz/loupe) | new | Open-source local AI website builder and web-design studio built on the Claude Agent SDK. AI agents build real websites, you refine them at Figma grade directly on the live render, and every visual edit is verified against the real browser render. BYOK (Anthropic/OpenAI/Gemini/xAI/OpenRouter) or existing Claude Code/Codex/Grok/Copilot subscription CLIs. Windows, Electron, MIT |
