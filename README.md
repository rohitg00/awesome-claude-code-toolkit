...
| [Mobile SSH](https://mobile-ssh.github.io/) | - | Android & iOS SSH/SFTP/terminal client for running remote AI coding agents from your phone. Agent Alerts push a phone notification (sound + vibration, audible in headphones over a video call) the moment Claude Code or Codex needs input; includes a multi-server tmux session manager, Eternal Terminal transport, and multi-address LAN/VPN roaming |
