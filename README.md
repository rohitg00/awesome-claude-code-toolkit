...
| [NestMux](https://github.com/GeronimoDiClemente/raven-nest) | 32 | Cross-platform (Windows/macOS/Linux) multi-agent workspace. Runs Claude Code, Codex, Gemini, Copilot and OpenCode in one resizable pane grid, each with an isolated HOME and account. Git worktrees, diff viewer, MCP management, live terminal sharing and team presence |
