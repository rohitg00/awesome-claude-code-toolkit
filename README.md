...
| [Akephalos](https://github.com/sunnja69/akephalos) | new | Local-first, markdown-first `.akephalos` passport for portable agent preferences, tool notes, rules, project context, and durable memories across Claude Code, Codex, Cursor, Hermes, OpenClaw, MCP clients, and machines via plain files/Git. v0.1.0 is an early prerelease. |
