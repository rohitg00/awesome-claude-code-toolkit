...
| [KittyClaw](https://github.com/Ekioo/KittyClaw) | new | Self-hosted kanban board where Claude Code agents are team members — per-agent roles (SKILL.md), persistent memory per agent, declarative automation engine, scheduled tickets, per-ticket token cost tracking. .NET/Blazor, MIT |
