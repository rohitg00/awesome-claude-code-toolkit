...
| [Fine Structure skills](https://github.com/finestructure-ai/humanizer-multilingual) | `/plugin marketplace add finestructure-ai/humanizer-multilingual` | Eight skills in one marketplace: AI-writing tells in 10 non-English languages, deploy preflight and postflight, comment hygiene, Windows shell correctness, WCAG 2.2 / EN 301 549 audit, i18n and RTL readiness, and agent rules migration between Cursor, Copilot, Windsurf and Claude. Each ships a zero-dependency scanner. |
