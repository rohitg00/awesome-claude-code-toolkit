...
| [SafeInstall](https://github.com/Mickdownunder/SafeInstall) | -- | Supply-chain gate for agent installs — MCP package checks (typosquat, release age, Sigstore provenance) plus enforced install-guard hooks for Claude Code, Codex, and Cursor with a tamper-evident trust surface. MIT. `npm install -g safeinstall-cli` |
