...
| [Atelier](https://myatelier.dev) | - | Native macOS canvas for running Claude Code and Codex in parallel. Hook-driven live run-state per agent, Work Areas with isolated git worktrees, terminal/browser/editor panels on one zoomable canvas. Paid (one-time purchase), 14-day free trial |
