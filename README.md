...
| [compounded](https://github.com/ankitkr3/compounded) | Learns from your corrections — approval-gated rules that earn autonomy through a trust ladder (verified → trusted → autonomous, demoted on mistakes) and inject at session start. Stop-hook capture, 55 tests, Python stdlib only, 100% local. Install: `/plugin marketplace add ankitkr3/compounded-marketplace` |
