...
| [Agent Sessions](https://github.com/jazzyalex/agent-sessions) | -- | Native macOS app to search, browse, and resume Claude Code, Codex, OpenCode, Cursor Agent, and ten other local agent CLIs, with live per-session quota burn for Codex and Claude |
