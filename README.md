...
| [artifact-driven-dev](https://github.com/moui72/artifact-driven-dev) | Skill pack replacing one-shot prompting with a plan -> tasks -> implement loop grounded in versioned project artifacts (constitution, plans, feature register). Delegated worktree implementation with deterministic branch-alignment checks, cross-artifact drift detection, and single-writer generated reports. Beta/stable release channels. |
...
| [artifact-driven-dev](https://github.com/moui72/artifact-driven-dev) | `cd my-project && curl -fsSL https://raw.githubusercontent.com/moui72/artifact-driven-dev/release/new.sh \| sh -s -- --existing` | Skill pack replacing one-shot prompting with a plan -> tasks -> implement loop grounded in versioned project artifacts (constitution, plans, feature register). Delegated worktree implementation, cross-artifact drift detection, single-writer generated reports. |
