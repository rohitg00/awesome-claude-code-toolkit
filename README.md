...
| [runtype-skills](https://github.com/runtypelabs/skills) | AI product development on Runtype's managed edge runtime — build, deploy, and operate agents, flows, tools, and surfaces. 6 skills covering product construction, flow design with typed step orchestration, Persona widget embedding for web/mobile, SDK & CLI workflows, and live account operations. MIT. Install: `/plugin marketplace add runtypelabs/skills` |
