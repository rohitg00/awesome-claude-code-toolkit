...
| [guardrail-agent](https://github.com/FvdHMBAI/guardrail) | Pre-execution security for AI coding agents. 172 production-tested guards, native Claude Code hook integration, self-bypass detection, EU AI Act compliance mapping. Install: `npx guardrail-agent init` |
