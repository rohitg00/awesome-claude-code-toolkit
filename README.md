...
| [polis-protocol](https://github.com/yehudalevy-collab/polis-protocol) | `git clone https://github.com/yehudalevy-collab/polis-protocol ~/.claude/skills/polis-protocol` | Markdown coordination protocol for multi-vendor agent teams. Signed capability cards (YAML), ε-greedy bandit routing that learns from settled contracts, chavruta paired review for high-stakes work, self-amending constitution. Vendor-agnostic — works across Claude Code, Codex, Gemini CLI. MIT. |
