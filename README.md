...
| [Agent Sessions](https://github.com/jazzyalex/agent-sessions) | 819+ | Native macOS app to browse, search, and resume local Claude Code, Codex, OpenCode, Cursor Agent, and other coding-agent session histories, with live per-session quota-burn tracking |
