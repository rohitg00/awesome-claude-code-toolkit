...
| [medical-research-skills](https://github.com/Aperivue/medical-research-skills) | `git clone` | 9 skills for the full medical research lifecycle: anti-hallucination literature search, 9 reporting guidelines (STROBE, PRISMA, STARD, CONSORT, TRIPOD+AI, ARRIVE, CARE, SPIRIT, CLAIM), statistical analysis, publication figures, study design, grant proposals, and presentation prep. Built by physicians, MIT licensed |
