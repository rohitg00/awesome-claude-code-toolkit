...
| [Superagent](https://github.com/pungme/superagent-desktop) | 24 | Open-source macOS desktop app giving Claude Code and Codex a real browser to navigate and drive, an iOS Simulator to install and screenshot apps in, and a phone companion app + relay for remote monitoring. Electron + SwiftUI, MIT |
