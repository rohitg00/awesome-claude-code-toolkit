...
| [opscale-setup](https://github.com/jordan23wagner-ops/opscale-setup) | new | One-command Claude Code setup — deploys 10 production hooks, 5 skills, CLAUDE.md, and settings.json tailored to your stack via a 3-question wizard. Zero deps, MIT. `npx opscale-setup` |
