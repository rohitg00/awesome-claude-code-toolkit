...
| [SandBase Agent Skills](https://github.com/sandbaseai/sandbase-skills) | `/plugin marketplace add sandbaseai/sandbase-skills` then `/plugin install sandbase-skills@sandbase-agent-skills` | 88 Apache-2.0 skills for research and business workflows, including portable multi-source search and offline report validation. |
