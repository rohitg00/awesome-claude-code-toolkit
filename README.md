...
| [10x](https://github.com/Aboudjem/10x) | -- | Curated plugin marketplace: sniff (AI QA), ui-ux-suite (design audit), recap-studio (offline explainer generator), aws-cost-audit (AWS cost skill). One install: `/plugin marketplace add Aboudjem/10x` |
