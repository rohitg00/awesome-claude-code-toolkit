...
| [SkillCheck-Free](https://github.com/olgasafonova/SkillCheck-Free) | `npx skills add olgasafonova/SkillCheck-Free` | Validates SKILL.md files against ~25 contract rules — structure, triggers, anti-pattern formatting, naming, semantic consistency. MIT-licensed. Works with Claude Code, Claude Desktop/Web, and Cursor. |
