...
| [DevIntern](https://github.com/getdevintern/devintern) | new | Tool that picks up tickets from Jira, Linear, Trello, Asana, Azure DevOps, GitHub Issues, or markdown files and turns them into self-reviewed pull requests by driving Claude Code non-interactively (also supports Codex, Cursor, OpenCode). Feasibility gate flags vague tickets back to the tracker; optional unattended mode schedules pickup and turns PR review comments into commits. Runs on your machines with your own Anthropic keys. FSL-1.1-Apache-2.0, free for interactive use. [Docs](https://devintern.com/docs) |
