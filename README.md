...
| [Computer Use](https://github.com/ridelink0/claude-computer-use) | Codex-style computer use for Claude Code: drives Windows and macOS apps through the accessibility tree (UI Automation, AXUIElement) rather than screenshots, about 20x cheaper, with safety tiers, one-call action sequences, and coexistence so you keep working on the same desktop while it works. MIT. |
