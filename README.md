...
| [ccstory](https://github.com/atomchung/ccstory) | new | Sibling to ccusage. Turns local Claude Code JSONL logs into a categorized weekly recap — active hours, costs, per-bucket narrative. `pipx install ccstory && ccstory week`. MIT, Python, zero telemetry. |
