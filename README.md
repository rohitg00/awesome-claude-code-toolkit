...
| [CubeLife](https://github.com/Ivy-Innovation/cubelife) | new | Give AI agents a persistent pixel-art character. MCP server (4 tools), Node/Python SDK, CLI. Characters live in rooms with emotions and creature companions. Desktop overlay, web embed, terminal renderer. `npx cubelife setup claude-code` |
