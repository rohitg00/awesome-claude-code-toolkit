...
| [50 Dark Themes for Claude Code](https://github.com/notgabriels-sys/claude-code-50-dark-themes) | New | MIT-licensed pack of 50 native Claude Code themes with semantic status colors and a visual gallery. Install with `/plugin marketplace add notgabriels-sys/claude-code-50-dark-themes`, then `/plugin install 50-dark-themes@notgabriels-themes`. |
