...
| [scip-cli](https://github.com/flesler/scip-cli) | `pip install scip-cli && scip-cli skill ~/.claude/skills/scip-cli/` | Token-efficient code intelligence for AI agents — precise refs, definitions, and repo health analysis (dead exports, cycles, coupling) via SCIP indexes. TypeScript/JavaScript and Python |
