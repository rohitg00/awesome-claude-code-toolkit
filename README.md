...
| [inference-labs-mcp](https://github.com/bosslesss/inference-labs-mcp) | Vendor-neutral MCP server for routing and comparing prompts across OpenAI/Azure, Anthropic, Google, and Bedrock. Includes auth-free pricing lookup + model recommendation tools, plus authenticated routing/comparison tools. Apache-2.0. |
