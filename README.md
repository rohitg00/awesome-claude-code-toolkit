...
| [ai-investment-skills](https://github.com/tellmefrankie/ai-investment-skills) | `cp ev-calculator/SKILL.md ~/.claude/skills/` | 6 investment analysis skills built from live portfolio management — EV Calculator, Options Flow Analyzer (real vs lottery calls), Investment Briefing Agent (9-wave), Price Monitor with Telegram alerts. Caught XLI P/C 5.32 anomaly live. Free tier + $29 pro bundle |
