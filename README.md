...
| [SocialClaw](https://github.com/ndesv21/socialclaw) | `npx skills add ndesv21/socialclaw` | Schedule and publish social media posts across 13 platforms (X, LinkedIn, Instagram, Facebook Pages, TikTok, Discord, Telegram, YouTube, Reddit, WordPress, Pinterest) via the SocialClaw API. One workspace API key for campaigns, media upload, schedule validation, and run analytics. MIT. |
