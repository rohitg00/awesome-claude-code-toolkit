...
| [UIZZE anti-ui-slop](https://github.com/uizze/uizze/tree/main/skills/anti-ui-slop) | `npx skills add https://uizze.com --skill anti-ui-slop` | STOP UI SLOP with a cross-agent workflow grounded in 800,000+ real web and iOS screens, product-specific design contracts, required states, and rendered finish gates. |
