...
| [argot](https://github.com/get-tmonier/argot) | Flags code foreign to a repo's own git-history-learned patterns — unfamiliar dependencies, reinvented functions, misplaced code, module-layering breaks, and tests weakened, disabled, or deleted alongside a production change. Provides Claude Code skills (setup, check, review-PR, CI, write-rule) and also runs as an MCP server. Single Rust binary, 100% local, no LLM. Install: `npx skills add get-tmonier/argot` |
