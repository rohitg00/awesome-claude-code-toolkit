...
| [claude-init](https://github.com/horiastanxd/claude-init) | new | One command generates AI context files -- CLAUDE.md, AGENTS.md, Cursor/Windsurf/Cline/Continue/Kilo Code/Trae rules, GEMINI.md, Copilot, Aider, Junie, Warp -- from a single repo scan. Runs as a CLI or MCP server, 100% local. `npx @horiastanxd/claude-init` |
