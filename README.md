...
| [octomux](https://github.com/ShreyPaharia/octomux) | 14 | Local dashboard for running parallel Claude Code and Cursor agents, each in its own git worktree. Unified permission inbox, live monitor grid, in-app diff review, and human-gated PR review. Local-first, MIT |
