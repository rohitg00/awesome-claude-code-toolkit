...
| [grafema](https://github.com/Disentinel/grafema) | Semantic code graph MCP server for AI coding agents. Indexes codebases into typed graphs (functions/types/modules as nodes; CALLS/IMPORTS/DATAFLOW/EFFECTS as typed edges) with 40+ tools for call-chain tracing, data-flow analysis, and semantic code search — so agents navigate code structure instead of reading files line by line. `npm install -g grafema` |
...
| [Grafema](https://github.com/Disentinel/grafema) | 35 | Semantic code graph MCP server for AI coding agents. Indexes codebases into typed graphs (functions/types/modules as nodes; CALLS/IMPORTS/DATAFLOW edges) with 40+ tools for call-chain tracing, data-flow analysis, and semantic code search. stdio transport. `npm install -g grafema` |
