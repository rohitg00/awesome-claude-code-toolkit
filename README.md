...
| [ccs](https://github.com/Ike-li/ccs) | new | Tiny Claude Code provider switcher for Anthropic-compatible endpoints. Homebrew install, DeepSeek/OpenRouter presets, `ccs doctor`, no proxy or daemon. |
