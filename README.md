...
| [Pluribus](https://github.com/caioribeiroclw-pixel/pluribus) | 2+ | Versioned AI context and receipt examples across Claude Code, Cursor, Codex, and OpenClaw. Syncs intentional context from one source of truth and documents privacy-safe receipts for loaded/suppressed context plus pre-mutation setup plans (`writes_started=false`). npm: `pluribus-context` |
