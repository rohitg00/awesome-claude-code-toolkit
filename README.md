...
| [Motion Graphics Skills](https://github.com/iart-ai/motion-skills) | `npx skills add iart-ai/tiktok-video-skills` (14 packs) | 50 skills across 14 installable packs for motion graphics, animation & video — kinetic typography, data-viz charts, explainers, TikTok/Reels, 3D WebGL, and Manim math animation. Each ships a render→screenshot→self-check loop; video via Remotion/Manim. MIT. |
