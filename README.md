...
| [google-maps-agent-skills](https://github.com/gmapsscraper/google-maps-agent-skills) | `npx skills add gmapsscraper/google-maps-agent-skills/google-maps-scraper` | 8 skills for Google Maps lead generation — scrape businesses, extract emails, find local leads, analyze competitors, write cold outreach. Two-layer: paid skills call API (2 credits/search), free skills process CSV locally. MIT-0 |
