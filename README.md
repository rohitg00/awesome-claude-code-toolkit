...
| [Riffkit](https://github.com/riffkit/skill) | `npx skills add riffkit/skill` | Riff a winning TikTok into your own short video — recreate a proven video's formula with your product, character, and language (EN/ES). Hosted AI backend, MIT skill spec. |
