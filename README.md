...
| [Ariadne Loop](https://github.com/zhangzeyu99-web/ariadne-loop) | new | Local-first loop-writing workbench for Claude Code, Codex, and AI coding agents. Turns rough task context into verifiable inspect-act-verify-decide packets, stop rules, rollback gates, and JSON reports. Includes `/ariadne-loop` command. |
