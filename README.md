...
| [accreted-intelligence](https://github.com/maxbaluev/accreted-intelligence) | Local-first Work Model plugin + MCP server for Claude Code, Codex, OpenCode, and Cursor. Two tools (`acc_retrieve`, `acc_act`) retrieve scored memory, record actions, and learn from real outcomes. Official MCP Registry: `io.github.maxbaluev/accint`. |
