...
| [BundleDex](https://bundledex.net) | new | Directory of Open Knowledge Format (OKF) bundles for AI agents — 400+ bundles with MCP tools, API, and llms.txt for Claude Code agent knowledge management |
