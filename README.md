...
| [x-skills](https://github.com/sergebulaev/x-skills) | `/plugin marketplace add sergebulaev/x-skills` | 6 X (Twitter) marketing skills: post writer, thread builder, hook extractor, humanizer, reply drafter, content planner |
