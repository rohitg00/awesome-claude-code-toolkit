...
| [pgyer-skill](https://github.com/PGYER/pgyer-skill) | `npx skills add PGYER/pgyer-skill` | Official skill from PGYER (蒲公英), China's leading mobile app beta-distribution platform (since 2014). Upload iOS / Android / HarmonyOS builds for beta testing; bundles GitHub Actions and GitLab CI templates. Cross-agent (Claude Code, Codex, Cursor, etc.); pairs with the official `pgyer-mcp-server`. MIT |
