...
| [yaps-plugins](https://github.com/richawo/yaps-plugins) | Marketplace of 11 plugins for the Yaps desktop app: voice dictation, file and meeting transcription with speaker labels, SRT subtitles, styled auto captions, audio cleanup, image background removal, text-to-speech, on-device translation, video-to-audio, and private Markdown memory. All processing runs locally through the installed app. MIT. Install: `/plugin marketplace add richawo/yaps-plugins` |
