...
| [yield-intelligence](https://github.com/thebrierfox/yield-intelligence-skill) | `git clone https://github.com/thebrierfox/yield-intelligence-skill && cp yield-intelligence-skill/SKILL.md ~/.claude/skills/yield-intelligence.md` | Passive income portfolio analysis — scans US Treasuries, dividend ETFs, REITs, and preferred stocks; ranks by risk-adjusted return; builds portfolio allocations targeting a specific monthly income goal. Works standalone (no API) or with live YIELD INTELLIGENCE MCP server data. |
| [moatmri](https://github.com/thebrierfox/moatmri-skill) | `git clone https://github.com/thebrierfox/moatmri-skill && cp moatmri-skill/SKILL.md ~/.claude/skills/moatmri.md` | AI disruption pressure analysis — runs 10-vector intelligence-pressure analysis on any business, builds an AI-takeover storyboard showing where Claude-native competitors attack first, and produces a 90-day counterstrike defense plan. |
| [doc2math](https://github.com/thebrierfox/doc2math-skill) | `git clone https://github.com/thebrierfox/doc2math-skill && cp doc2math-skill/SKILL.md ~/.claude/skills/doc2math.md` | Document-to-Mathematics formalization engine — converts research papers, problem specs, and technical docs into a formal Mathematical Problem Specification (MPS) with variables, operators, constraints, objectives, and uncertainty. Uses Zero-Inference Protocol for closed-world grounding. |
