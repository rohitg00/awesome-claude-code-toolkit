...
| [AsOf](https://github.com/amatayomosley-web/asof) | Temporal-awareness hooks for Claude Code that flag stale in-context data before it corrupts reasoning. Tracks file mtime drift between Reads, parses prompts for embedded dates (Q3 2025, dated stock data), and surfaces gaps against the training cutoff. Complements time-injection plugins like temporal-core. MIT, `pip install asoftime && asof install`. |
