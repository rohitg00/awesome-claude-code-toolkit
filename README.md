...
| [mindpowers](https://github.com/rohitgehe05/mindpowers) | Socratic brainstorming for knowledge-work docs (PRDs, business reviews, decision docs). Interview-style questioning, two approval gates (spec approved verbally, then in writing) before drafting; a cousin of superpowers for non-code work. MIT |
