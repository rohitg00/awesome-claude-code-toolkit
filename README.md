...
| [Agent Island](https://github.com/tristan666666/agent-island) | new | Native macOS notch companion for Claude/Codex sessions. Shows live state on the matching logo (running, waiting, stuck) and can auto-resume a selected long-running session |
