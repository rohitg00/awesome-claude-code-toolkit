...
| [Socratic Code Reviewer](https://github.com/laki-arnsteinlarsen/strategistkit-skills/tree/main/socratic-code-reviewer) | `git clone https://github.com/laki-arnsteinlarsen/strategistkit-skills && cp -r strategistkit-skills/socratic-code-reviewer ~/.claude/skills/` | Reviews code/diffs by interrogating intent, edge cases, and trade-offs; a senior reviewer's questions, not a checklist |
| [Systematic Bug Debugger](https://github.com/laki-arnsteinlarsen/strategistkit-skills/tree/main/systematic-bug-debugger) | `git clone https://github.com/laki-arnsteinlarsen/strategistkit-skills && cp -r strategistkit-skills/systematic-bug-debugger ~/.claude/skills/` | Root-cause debugging from symptoms and stack traces; handles heisenbugs and "works locally, fails in prod" |
| [TDD Loop Master](https://github.com/laki-arnsteinlarsen/strategistkit-skills/tree/main/tdd-loop-master) | `git clone https://github.com/laki-arnsteinlarsen/strategistkit-skills && cp -r strategistkit-skills/tdd-loop-master ~/.claude/skills/` | Drives red-green-refactor: builds a test list, writes tests first, keeps the discipline tight |
