...
| [NotFair](https://github.com/nowork-studio/NotFair) | Open-source Claude Code skills for SEO, GEO, Google Ads, and Meta Ads. Connects to live data via Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP. Skills cover site analysis, keyword research, meta tags, schema markup, GEO optimization, ad audits, wasted-spend detection, ROAS analysis, and creative fatigue. ~2.9k stars, MIT |
