...
| [claude-carbon](https://github.com/gwittebolle/claude-carbon) | Carbon footprint tracking for Claude Code sessions - live CO2 estimate in the status line, per-model reports, shareable PNG report cards (EN/FR). Bash + SQLite, published methodology, MIT. Install: `npx claude-carbon` |
