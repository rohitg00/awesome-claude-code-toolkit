...
| [Claude Pet](https://github.com/nikhilagrima/claude-pet) | new | Cross-platform desktop mascot for Claude Code. Reacts to hook events, keeps local graph memory per project injected on SessionStart, promotes patterns into SKILL.md, watches GitHub activity. Python + PySide6, MIT |
