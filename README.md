...
| [Skillselion](https://skillselion.com) | new | Directory of thousands of community-vetted Claude Code skills, MCP servers & marketplaces ranked by real install counts. Its `skillselion-mcp` server lets an agent search and `load_skill` a real SKILL.md mid-task. `npx -y skillselion-mcp` |
