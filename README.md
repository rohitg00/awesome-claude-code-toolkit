...
| [Aicoo Skills](https://www.aicoo.io) | `export AICOO_API_KEY=aicoo_sk_live_xxx` | AI COO agent skills — share agent via secure links, agent-to-agent communication (Pulse Protocol), autonomous heartbeat loops, context sync, Aicoo Square discovery board, group chats |
