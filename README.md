...
| [RunAPI MCP Server](https://github.com/runapi-ai/mcp) | 130+ AI models for image, video, music, audio, and LLM generation from 18 providers. Free catalog tools for model discovery and pricing; authenticated tools for media task creation, polling, and LLM chat. Run with `npx @runapi.ai/mcp`. |
