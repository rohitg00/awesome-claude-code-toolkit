...
| [50 Dark Themes for Claude Code](https://github.com/notgabriels-sys/claude-code-50-dark-themes) | New | MIT-licensed pack of 50 native Claude Code themes with semantic status colors, a [visual gallery](https://notgabriels-sys.github.io/claude-code-50-dark-themes/), and a [stable v1.0.0 release](https://github.com/notgabriels-sys/claude-code-50-dark-themes/releases/tag/themes-plugin-v1.0.0). Install with `/plugin marketplace add notgabriels-sys/claude-code-50-dark-themes`, then `/plugin install 50-dark-themes@notgabriels-themes`. |
