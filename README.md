...
| [Alfred](https://github.com/luminik-io/alfred-os) | new | Local runtime that turns GitHub issues and specs into autonomous Claude Code and Codex runs. Uses clean worktrees, label state, engine routing, and Slack reports |
