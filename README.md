...
| [EGC](https://github.com/Fmarzochi/EGC) | Local-first MCP runtime with persistent memory for Claude Code. Cross-session context, project memory, shared workflows. TypeScript, zero cloud dependencies. |
