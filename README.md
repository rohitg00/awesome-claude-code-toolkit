...
| [LWC](https://github.com/JanYork/llm-wiki-cli) | 31+ | Source-grounded proactive project memory for Claude Code and other coding agents. Immutable sources, citations, provenance, and atomic changesets; SQLite/FTS5 recall, optional document/code graphs, lifecycle hooks, and a bounded one-tool MCP interface. Apache-2.0 |
