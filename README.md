...
| [Bashi](https://github.com/BasharAmso/Bashi) | new | AI orchestration framework that turns Claude Code into a structured dev team. Dispatch chain routes tasks to 12 specialized agents, parallel worktree execution, overnight unattended runs with circuit breakers, 600+ skill procedures via [Cortex MCP](https://github.com/BasharAmso/cortex-mcp). Install: `npx create-bashi-app` |
