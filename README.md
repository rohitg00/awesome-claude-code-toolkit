...
| [tokenhabit](https://github.com/epoko77-ai/tokenhabit) | new | Scans your Claude Code logs for token-wasting *habits* and ranks them, each with a copy-paste fix, plus an A–F Waste Score. Diagnosis complement to ccusage. Offline, zero LLM calls |
