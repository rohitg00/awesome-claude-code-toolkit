...
| [gcf-proxy](https://github.com/blackwell-systems/gcf-claude-plugin) | Save 71% on MCP tool call tokens. Wraps any MCP server with GCF encoding, zero code changes. Setup/stats skills + session savings hook. 100% comprehension across 1,700+ LLM evaluations. `npm install -g @blackwell-systems/gcf-proxy` |
