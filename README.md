...
| [agentops](https://github.com/baramgay/agentops) | new | Production-ready multi-agent orchestration for Claude Code. 33 specialized agents, vertical command chain (OC→Lead→Specialist), live WebSocket dashboard, native issue tracker (GNI-N), Obsidian-compatible wiki with MoC auto-indexing, and token-efficiency hooks. MIT |
