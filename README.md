...
| [EGC](https://github.com/Fmarzochi/EGC) | Local-first MCP runtime with persistent memory for Claude Code, Gemini CLI, Cursor and Codex. Cross-session context, project memory, shared workflows. TypeScript, runs fully local. |
