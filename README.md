...
| [cca-audit](https://github.com/GiulioDER/cca-audit) | 6-layer parallel code audit pipeline. Runs 6 specialized LLM auditors (code quality, bugs, security, performance, docs, config) with non-overlapping scopes — zero duplicate findings. Deduplicates, prioritizes P1/P2/P3, auto-fixes, re-verifies tests, architect review gate. Three variants: Claude Code slash command, Codex CLI shell script, OpenRouter Python CLI. MIT |
