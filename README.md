...
| [FlowHunt](https://github.com/heyneuron/flowhunt-skill) | `npx skills add heyneuron/flowhunt-skill` | Automation discovery audit — walks through a 5-question workflow intake, audits connected sources (Gmail, Calendar, Slack, task trackers), and produces a ranked markdown report of automation opportunities with estimated time savings. |
