...
| [KBLite](https://github.com/76Hata/KBLite) | new | Lightweight Windows browser UI for Claude Code with local conversation memory (SQLite + FTS5) -- resume by history ID, fork conversations, full-text search. Installer-based, no Docker/WSL |
