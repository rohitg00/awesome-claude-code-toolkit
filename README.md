...
| [suede-creator-skills](https://github.com/JasonColapietro/suede-creator-skills) | `npx skills add JasonColapietro/suede-creator-skills@suede-workflow-skills` | 21-skill pack for music creator workflows: Rights Passport, Campaign in a Box, provenance mapping, royalty routing, SEO/AEO/AI EO audits, A-F code grading, design QA, agent commerce prep. MIT licensed. |
