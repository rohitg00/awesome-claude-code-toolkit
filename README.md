...
| [EDC](https://github.com/almogdepaz/EDC) | Local repo-context plugin, slash-command, hook, and terminal CLI for Claude Code, Cursor, Codex, and pi. Generates `edc-context/` module docs, invariants, trust boundaries, review notes, and routing metadata, then uses that context during review/audit workflows. |
