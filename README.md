...
| [claude-dash](https://github.com/krabat-l/claude-dash) | new | Real-time statusline for Claude Code -- context, cost, quota, cache, tools, and git status. Zero dependencies, component-based with themes |
