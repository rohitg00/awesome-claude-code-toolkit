...
| [one-shot-prompting](https://github.com/usmanmughaltaleemabad/One-Shot-Plugin) | Agentic feature generation for Claude Code. Describe a feature in natural language → get production-ready models, services, endpoints, tests, migrations, and main.py wiring in 2–3 minutes. 14 pipeline stages, 8 specialist agents (architect, implementer, reviewer, critic…), FastAPI/Django/Spring/Go/NestJS. Available in Claude Plugins Community. |
